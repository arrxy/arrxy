...
Currently pursuing MS in Computer Science at **New York University**, while contributing to **systems-level open source** and building scalable backend platforms.

---

#### What I'm Working On

• Contributing to database and systems open source (Postgres ecosystem, ParadeDB)  
• Studying database internals, storage engines, and query execution  
• Building fault-tolerant event-driven systems using Kafka and Redis  
• Exploring systems for AI workloads and vector databases  

---

#### Engineering Experience

• Built backend systems serving **13M+ users in production**  
• Architected pipelines processing **10,00+ events/sec**  
• Designed **multi-level distributed referral infrastructure**  
...
• Contributor to ParadeDB (Postgres-based analytical database)  
• Actively studying and contributing to database internals  
• Focus areas:
  - Query execution
  - Storage engines
  - Distributed systems
